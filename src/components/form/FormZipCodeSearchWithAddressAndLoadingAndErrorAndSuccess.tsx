/**
 * Arquivo: FormZipCodeSearchWithAddressAndLoadingAndErrorAndSuccess.tsx
 * Caminho: src/components/form/FormZipCodeSearchWithAddressAndLoadingAndErrorAndSuccess.tsx
 * Criado em: 2025-06-07
 * Última atualização: 2025-06-07
 * Descrição: Componente de busca de CEP com preenchimento automático de endereço, indicador de carregamento, tratamento de erros e feedback de sucesso integrado com react-hook-form e Material UI, com suporte a validação e acessibilidade
 */
...
export interface FormZipCodeSearchWithAddressAndLoadingAndErrorAndSuccessProps<T extends FieldValues> {
  name: Path<T>;
  control: Control<T>;
  label?: string;
  placeholder?: string;
...
const FormZipCodeSearchWithAddressAndLoadingAndErrorAndSuccess = <T extends FieldValues>({
  name,
  control,
  label = 'CEP',
  ...
  onSuccess,
  sx,
}: FormZipCodeSearchWithAddressAndLoadingAndErrorAndSuccessProps<T>) => {
...
export default FormZipCodeSearchWithAddressAndLoadingAndErrorAndSuccess; 
