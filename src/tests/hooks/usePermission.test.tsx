...
import { TestUser } from '../../tests/types';
...
describe('usePermission', () => {
  ...
  it('deve lidar com permissões vazias ou inválidas', () => {
    ...
    expect(result.current.hasPermission(null as unknown as string)).toBeFalsy();
    expect(result.current.hasPermission(undefined as unknown as string)).toBeFalsy();
  });
  ...
  it('deve lidar com array de permissões vazio ou inválido', () => {
    ...
    expect(result.current.hasAnyPermission(null as unknown as string[])).toBeFalsy();
    expect(result.current.hasAnyPermission(undefined as unknown as string[])).toBeFalsy();

    expect(result.current.hasAllPermissions([])).toBeFalsy();
    expect(result.current.hasAllPermissions(null as unknown as string[])).toBeFalsy();
    expect(result.current.hasAllPermissions(undefined as unknown as string[])).toBeFalsy();
  });
}); 