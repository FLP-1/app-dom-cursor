  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    try {
      ...
      if (err && typeof err === 'object' && 'message' in err) {
        notificationService.error((err as { message?: string }).message || 'Erro ao fazer login');
      } else {
            ...
            <Box margin="0 0 20px">
              <LabelRow>
                <PasswordInput
                  ...
                  autoComplete="off"
                />
                <CTAInlineLink href="/forgot-password" style={{ fontSize: '0.8rem' }}>
                  Esqueci minha senha
                </CTAInlineLink>
              </LabelRow>
            </Box>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                <span>
                  ...
                  <Link href="/terms-of-use" passHref legacyBehavior>
                    <CTAInlineLink target="_blank" style={{ fontSize: '0.8rem' }}>
                      Termos de Uso
                    </CTAInlineLink>
                  </Link>
                </span>
                <Link href="/privacy-policy" passHref legacyBehavior>
                  <CTAInlineLink target="_blank" style={{ marginTop: 2, fontSize: '0.8rem' }}>
